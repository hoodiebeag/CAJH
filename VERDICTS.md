...
| H11 | Funding-rate gate (Binance perp funding <=0.01%) on `anticipate` | pending, pre-registered (never actually run - last attempt 2026-08-04 got 0 eligible assets, a data-gate not a real test, same pattern PWR1 fixed elsewhere) | Gate: train trades>=200 & holdout trades>=80, both avgR>0, holdout positive-asset rate>=50% | — | staged 2026-08-08 | b742646 (spec) |
