...
Sections moved verbatim from ROADMAP.md by the DOCS-ARCHIVE-CONVENTION work-queue item
(2026-09-02). Nothing here was summarised, rewritten, or deleted -- this is the same prose,
relocated. See ROADMAP.md's "Archived sections" index for the full list and the reason one
section in this date range was kept in ROADMAP.md instead of moved here.
