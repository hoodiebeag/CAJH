...
export const FEE_BUFFER_PCT = 0.018; // the breakeven stop sits at least this % above entry to clear round-trip fees (~1.71% verified Kraken Tier 1 taker round trip) plus ~5% headroom. Lower it if your fee tier improves.
export const FEE_RATE       = 0.008; // per-side taker fee estimate, used to show P&L net of fees (round trip ≈ 1.6%)
