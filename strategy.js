...
export const FEE_BUFFER_PCT = 0.01;  // the breakeven stop sits at least this % above entry to clear round-trip fees (~1.6% Kraken taker) plus margin. Lower it if your fee tier improves.
